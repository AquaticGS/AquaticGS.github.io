...
function playVids(videoId) {
    ...
    if (vid.readyState > 3) {
        ...
        function drawLoop() {
            ...
            mergeContext.clearRect(0, 0, vidWidth, vidHeight); // Clear canvas for each redraw
            mergeContext.drawImage(vid, 0, 0, vidWidth * position, vidHeight, 0, 0, vidWidth * position, vidHeight);
            mergeContext.drawImage(vid, vidWidth * position, 0, vidWidth * (1 - position), vidHeight, vidWidth * position, 0, vidWidth * (1 - position), vidHeight);
